...
![PHP](https://img.shields.io/badge/PHP-7.4%20|%208.1%20|%208.2%20|%208.3%20|%208.4%20|%208.5-purple?style=flat-square&logo=php)
...
### 🔧 Technische Features
- **PHP Support** - PHP 7.4 (legacy), 8.1, 8.2, 8.3, 8.4 (empfohlen), 8.5 (neueste)
...
3. **Instanz konfigurieren** - Name, PHP-Version (7.4, 8.1–8.5, Standard: 8.4), MariaDB (10.11–11.8, Standard: 11.4)
